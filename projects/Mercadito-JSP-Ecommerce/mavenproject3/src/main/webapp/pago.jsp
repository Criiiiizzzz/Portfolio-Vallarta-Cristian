...
<html lang="en" >
    ...
    <head>
        ...
        <link rel="stylesheet" href="pago.css" type="text/css">
        ...
        <div class="checkout">
            ...
            <form class="form" autocomplete="off" novalidate>
                <fieldset>
                    ...
                    <input type="num" id="card-number" class="input-cart-number" maxlength="4" onkeypress="return event.charCode >= 48 & amp; & amp; event.charCode <= 57"/>
                    <input type="num" id="card-number-1" class="input-cart-number" maxlength="4" onkeypress="return event.charCode >= 48 & amp; & amp; event.charCode <= 57"/>
                    <input type="num" id="card-number-2" class="input-cart-number" maxlength="4" onkeypress="return event.charCode >= 48 & amp; & amp; event.charCode <= 57"/>
                    <input type="num" id="card-number-3" class="input-cart-number" maxlength="4" onkeypress="return event.charCode >= 48 & amp; & amp; event.charCode <= 57"/>
                </fieldset>
                <fieldset>
                ...
                <fieldset class="fieldset-ccv">
                    ...
                    <input type="text" id="card-ccv" maxlength="3" onkeypress="return event.charCode >= 48 & amp; & amp; event.charCode <= 57"/>
                </fieldset>
                <a href="index.html"><button class="btn"><i class="fa fa-lock"></i> Pagar</button></a>
            </form>
        </div>
