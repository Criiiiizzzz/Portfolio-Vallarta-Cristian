...
<html lang="es">
    ...
    <body style="background-color: white;">
        ...
        <section class="container">
            ...
            <h3 class="title"> &bull; Frutas y Verduras &bull; </h3>
            <h2 class="main-header__txt">Seleccione a su producto favorito.</h2>

            <div class="products-container">

                <div class="product" data-name="p-1">
                    <a href="productos_fresa.jsp"><img src="images/1.png" alt=""></a>
                    <h3>Fresas</h3>
                    <div class="price">$35.00 kg</div>
                </div>

                <div class="product" data-name="p-2">
                    <a href="productos_cebolla.jsp"><img src="images/2.png" alt=""></a>
                    <h3>Cebollas</h3>
                    <div class="price">$18.00 kg</div>
                </div>

                <div class="product" data-name="p-3">
                    <a href="productos_jitomate.jsp"><img src="images/3.png" alt=""></a>
                    <h3>Jitomates</h3>
                    <div class="price">$29.00 kg</div>
                </div>

                <div class="product" data-name="p-4">
                    <a href="productos_berenjena.jsp"><img src="images/4.png" alt=""></a>
                    <h3>Berenjena</h3>
                    <div class="price">$52.00 kg</div>
                </div>

                <div class="product" data-name="p-5">
                    <a href="productos_brocoli.jsp"><img src="images/5.png" alt=""></a>
                    <h3>Brocoli</h3>
                ...
                <%
                    ...
                    try {
                        result = stat.executeQuery("select*from productos where tipo_producto='Frutas'");
