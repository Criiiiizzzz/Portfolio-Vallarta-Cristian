    ...
    <body>
        ...
        <div id="container">
            ...
            <div class="product" data-name="p-6">
                <a href="chabacano.jsp"><img src="imagenes/fruta6.jfif"alt=""></a>
                <h3>Chabacano</h3>
                <div class="price">$42.00</div>
            </div>
            <form action="chabacanoo.jsp" method="post">
                        <h3>Cantidad de chabacanos</h3>
                        <select name="fresa">
                                <option>1kg Chabacanos</option>
                                <option>2kg Chabacanos</option>
                                <option>3kg Chabacanos</option>
                            </select>
                        <input style="color: black;" type="submit" value="acceptar">
            </form>
