        ...
        <section class="container">
            ...
            <div class="products-container">
                ...
                <div class="product" data-name="p-1">
                    ...
                    <h3>Ribeye de res</h3>
                    <div class="price">$2033.00</div>
                </div>

                <div class="product" data-name="p-2">
                    <a href="carne2.jsp"><img src="imagenes/carne2.jfif" alt=""></a>
                    <h3>Filete de lomo de res</h3>
                    <div class="price">$80.00</div>
                </div>

                <div class="product" data-name="p-3">
                    <a href="carne3.jsp"><img src="imagenes/carne3.jfif" alt=""></a>
                    <h3>Tomahawk</h3>
                    <div class="price">$100.00</div>
                </div>

                <div class="product" data-name="p-4">
                    <a href="carne4.jsp"><img src="imagenes/carne4}.jfif" alt=""></a>
                    <h3>Costilla de res</h3>
                    <div class="price">$90.00</div>
                </div>

                <div class="product" data-name="p-5">
                    <a href="carne5.jsp"><img src="imagenes/carne5.jfif" alt=""></a>
                    <h3>Vacío de res</h3>
                    <div class="price">$120.00</div>
                </div>

                <div class="product" data-name="p-6">
                    <a href="carne6.jsp"><img src="imagenes/carne6.jfif" alt=""></a>
                    <h3>Tapa de ribeye de res</h3>
                ...
                <%
                    ...
                    try {
                        result = stat.executeQuery("select*from productos where tipo_producto='Carnes'");
