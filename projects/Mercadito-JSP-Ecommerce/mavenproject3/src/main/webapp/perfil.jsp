            ...
            <div id="container">
                ...
                <form id="contact_form">
                    <%
                        ...
                        try {
                            contra = request.getParameter("user");
                            results = stat.executeQuery("select * from usuarios where usuario='" + contra + "';");
                            if (results.next()) {
                    ...
                    <div class="telephone">
                        ...
                        <br><br>
                        <input type="text" onkeypress="validar(event, 'letras')" placeholder="Usuario" name="user" id="telephone_input" value="<%out.println(results.getString("usuario"));%>" readonly >
                    </div>
                    <div class="name">
                        <label for="name">USUARIO</label>
                        <br><br>
                        <input type="text" onkeypress="validar(event, 'letras')" placeholder="Nombre" name="nom_user" id="name_input" value="<%out.println(results.getString("nom_user"));%>" readonly>
                    </div>

                    <div class="email">
                        <label for="email">APELLIDO PATERNO</label>
                        <br><br>
                        <input type="text" placeholder="Apellido Paterno" onkeypress="validar(event, 'letras')" name="ap_paterno_user" value="<%out.println(results.getString("ap_paterno_user"));%>" readonly>
                    </div>

                    <div class="name">
                        <label for="name">APELLIDO MATERNO</label>
                        <br><br>
                        <input type="text" onkeypress="validar(event, 'letras')" placeholder="Apellido Materno" name="ap_materno_user" id="name_input" value="<%out.println(results.getString("ap_materno_user"));%>" readonly>
                    </div>

                    <div class="email">
                        <label for="email">EMAIL</label>
                        <br><br>
                        <input type="email" placeholder="E-mail" name="email" id="email_input" value="<%out.println(results.getString("email"));%>" readonly>
                    </div>

                    <div class="email">
                        <label for="email">TELÉFONO</label>
                        <br><br>
                        <input type="text" onkeypress="validar(event, 'numeros')" placeholder="Numero Telefónico" name="num_user" id="telephone_input"  value="<%out.println(results.getString("num_user"));%>"readonly>
                    </div>
                    <div class="name">
                        <label for="email">CONTRASEÑA</label>
                        <br><br>
                        <input type="text"  placeholder="Contraseña" name="contrasenia" id="name_input" value="<%out.println(results.getString("contrasenia"));%>" readonly>
                    </div>
                    <%}
                    else {
