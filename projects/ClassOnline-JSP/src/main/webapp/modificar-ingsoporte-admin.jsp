                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="left-info" align="center" style="color: white">
                                                    ...
                                                    <%
                                                        ...
                                                        try {
                                                            result = stat.executeQuery("select*from ingeniero_soporte where soporte='" + user + "'");
                                                            result.next();
                                                    %>
                                                    <form action="" method="post" id="contact_form">
                                                        ...
                                                        <div class="nombre">
                                                            <label for="name"></label>
                                                            <input  type="text" placeholder="Nombre" name="nombre_soporte" pattern="^[a-zA-ZÀ-ÿ\u00f1\u00d1\u00E0-\u00FC]+(\s*[a-zA-ZÀ-ÿ\u00f1\u00d1\u00E0-\u00FC]*)*[a-zA-ZÀ-ÿ\u00f1\u00d1\u00E0-\u00FC]+$" value="<%=result.getString("nombre_soporte")%>" id="name_input" required>
                                                        </div>
                                                        <p>Email</p>
                                                        <div class="apellidos">
                                                            <label for="apellidos"></label>
                                                            <input  type="text" placeholder="Email" pattern="^[a-zA-ZÀ-ÿ\u00f1\u00d1\u00E0-\u00FC]+(\s*[a-zA-ZÀ-ÿ\u00f1\u00d1\u00E0-\u00FC]*)*[a-zA-ZÀ-ÿ\u00f1\u00d1\u00E0-\u00FC]+$" name="email_soporte" value="<%=result.getString("email_soporte")%>" required>
                                                        </div>
                                                        <p>Contraseña</p>
                                                        <div class="correo">
                                                            <label for="email"></label>
                                                            <input  type="text" placeholder="CONTRASEÑA" name="contrasenia_soporte" id="email_input" value="<%=result.getString("contrasenia_soporte")%>" required>
                                                        </div> 
                                                        <br><br><br>
                                            ...
                                            <%
                                                ...
                                                if (request.getParameter("btngrabar") != null) {
                                                    ...
                                                    String nom = new String(request.getParameter("nombre_soporte").getBytes("ISO-8859-1"), "UTF-8");
                                                    String mail = new String(request.getParameter("email_soporte").getBytes("ISO-8859-1"), "UTF-8");
                                                    String con = new String(request.getParameter("contrasenia_soporte").getBytes("ISO-8859-1"), "UTF-8");
                                                    stat.execute("update ingeniero_soporte set soporte='" + user2 + "', nombre_soporte='" + nom + "', email_soporte='" + mail + "', contrasenia_soporte='" + con + "'where soporte='" + user + "';");
