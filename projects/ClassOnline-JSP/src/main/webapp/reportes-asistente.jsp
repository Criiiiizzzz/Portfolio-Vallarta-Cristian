                                    ...
                                    <div class="content">
                                        <div class="row" style="color: white">
                                            ...
                                            <%
                                                ...
                                                try {
                                                    result = stat.executeQuery("select * from reportes");
                                                    out.println("<table border='1' align=center >"
                                                            + "<th>Código</th>"
                                                            + "<th>Usuario</th>"
                                                            + "<th>Descripción</th>");
                                                    while (result.next()) {
                                                        String id = result.getString("Id_reporte"); //llave primaria de la base de datos, no del formualrio y con eso arrastra los demas datos
                                                        String nombre = result.getString("usuario");
                                                        String reporte = result.getString("reporte");
                                                        out.println("<tr>");
                                                        out.println("<td>" + id + "</td>");
                                                        out.println("<td>" + nombre + "</td>");
                                                        out.println("<td>" + reporte + "</td>");
                                                        out.println("</tr>");
                                                    }
                                                    out.println("</table>");
