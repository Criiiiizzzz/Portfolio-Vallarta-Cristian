            ...
            try{
                ...
                if(results.next()){
                    ...
                    <script type="text/javascript">
                       ...
                       setTimeout( function() { window.location.href = "inicio-usuario.html?user=<%=user%>"; }, 3000 );
                    </script>
                    <%
                }else{
                ...
                %>
                    ...
                    <script type="text/javascript">
                       //Redireccionamiento tras 5 segundos
                       setTimeout( function() { window.location.href = "inicio-admin.html?admin=<%=user%>"; }, 3000 );
                    </script>
                    <%
                    
                }else{
                results=sta.executeQuery("select*from asistentes where asistente='"+user+"' and contrasenia_asistente='"+con+"';");
                if(results.next()){

                %>
                    <script src="//cdn.jsdelivr.net/npm/sweetalert2@11"></script> 
                    <script>alert('¡Bienvenido a la Página Asistente!');</script> 
                    
                    <script type="text/javascript">
                       //Redireccionamiento tras 5 segundos
                       setTimeout( function() { window.location.href = "inicio-asistente.html?admin=<%=user%>"; }, 3000 );
                    </script>
                    <%
                ...
                %>
                    ...
                    <script type="text/javascript">
                       //Redireccionamiento tras 5 segundos
                       setTimeout( function() { window.location.href = "inicio-ing-soporte.html?admin=<%=user%>"; }, 3000 );
                    </script>
                    <%
                ...
                %>
                    ...
                    <script type="text/javascript">
                       //Redireccionamiento tras 5 segundos
                       setTimeout( function() { window.location.href = "inicio-ger-soporte.html?admin=<%=user%>"; }, 3000 );
                    </script>
                    <%
                ...
                %>
                    ...
                    <script type="text/javascript">
                       //Redireccionamiento tras 5 segundos
                       setTimeout( function() { window.location.href = "inicio-ger-mantenimiento.html?admin=<%=user%>"; }, 3000 );
                    </script>
                    <%
                ...
                %>
                    ...
                    <script type="text/javascript">
                       //Redireccionamiento tras 5 segundos
                       setTimeout( function() { window.location.href = "inicio-ing-mantenimiento.html?admin=<%=user%>"; }, 3000 );
                    </script>
                    <%
                ...
                %>
                    ...
                    <script type="text/javascript">
                       //Redireccionamiento tras 5 segundos
                       setTimeout( function() { window.location.href = "inicio-maestro.html?admin=<%=user%>"; }, 3000 );
                    </script>
                    <%
