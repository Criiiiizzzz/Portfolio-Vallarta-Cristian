                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="left-info" align="center" style="color: white">
                                                    ...
                                                    <form action="" method="post" id="contact_form">
                                                        ...
                                                        <div class="nombre">
                                                            <label for="name"></label>
                                                            <input  type="text" placeholder="Nombre" name="nombre" pattern="^[a-zA-ZÀ-ÿ\u00f1\u00d1\u00E0-\u00FC]+(\s*[a-zA-ZÀ-ÿ\u00f1\u00d1\u00E0-\u00FC]*)*[a-zA-ZÀ-ÿ\u00f1\u00d1\u00E0-\u00FC]+$" value="<%=result.getString("nombre")%>" id="name_input" required>
                                                        </div>
                                                        <p>Email</p>
                                                        <div class="apellidos">
                                                            <label for="apellidos"></label>
                                                            <input  type="text" placeholder="Email" pattern="^[a-zA-ZÀ-ÿ\u00f1\u00d1\u00E0-\u00FC]+(\s*[a-zA-ZÀ-ÿ\u00f1\u00d1\u00E0-\u00FC]*)*[a-zA-ZÀ-ÿ\u00f1\u00d1\u00E0-\u00FC]+$" name="email" value="<%=result.getString("email")%>" required>
                                                        </div>
                                                        <p>Contraseña</p>
                                                        <div class="correo">
                                                            <label for="email"></label>
                                                            <input  type="text" placeholder="CONTRASEÑA" name="contrasenia" id="email_input" value="<%=result.getString("contrasenia")%>" required>
                                                        </div> 
                                                        <br><br><br>
                                            ...
                                            <%
                                                ...
                                                if (request.getParameter("btngrabar") != null) {
                                                    ...
                                                    stat.execute("update usuarios set usuario='" + user2 + "', nombre='" + nom + "', email='" + mail + "', contrasenia='" + con + "'where usuario='" + user + "';");
                                            ...
                                            <script type="text/javascript">
                                                        ...
                                                        setTimeout(function () {
                                                            window.location.href = "eliminar_usuario.jsp?admin=<%=admin%>";
                                                        }, 3000);
                                            </script> 
                                            <%
