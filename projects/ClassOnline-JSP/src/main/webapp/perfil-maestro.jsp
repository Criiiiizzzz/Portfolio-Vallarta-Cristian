    ...
    <head>
        ...
        <script>
            ...
            function Agregar_materias() {
                window.location.href = ("agregar-materias.jsp?admin=" + userParam);
            }
            function Eliminar_temas() {
                window.location.href = ("eliminar-temas.jsp?admin=" + userParam);
            }
                                                ...
                                                <div class="left-info" align="center">
                                                    ...
                                                    <%
                                                        ...
                                                        try {
                                                            ...
                                                            conec = DriverManager.getConnection("jdbc:mysql://localhost/Devil?autoReconnect=true&useSSL=false", "root", "n0m3l0");
                                                        ...
                                                        try {
                                                            ...
                                                            results = stat.executeQuery("select * from maestros where contrasenia_admin='" + contra + "';");
                                            ...
                                            <div class="col-lg-6">
                                                <div class="left-info" align="left">
                                                    <div align=""class="main-border-button">
                                                        <h3>Funciones</h3>
                                                        <br>
                                                        <a  href="javascript:void(0)" onclick="Consultar_usuarios()"> Consultar Usuarios </a>
                                                        <br><br>
                                                        <a  href="javascript:void(0)" onclick="Eliminar_usuarios()"> Eliminar / Modificar Usuarios </a>
                                                        <br><br>
                                                        <a  href="javascript:void(0)" onclick="Consultar_soporte()"> Consultar Soporte  </a>
                                                        <br><br>
                                                        <a  href="javascript:void(0)" onclick="Eliminar_soporte()"> Eliminar / Modificar Soporte </a>
                                                        <br><br>
                                                        <a  href="javascript:void(0)" onclick="Agregar_materias()">  Agregar Temas </a>
                                                        <br><br>
                                                        <a  href="javascript:void(0)" onclick="Eliminar_temas()"> Eliminar / Modificar Temas  </a>
                                                        <br><br>
                                                        <a  href="javascript:void(0)" onclick="Agregar_profesores()"> Agregar Profesores</a>
                                                        <br><br>
                                                        <a  href="javascript:void(0)" onclick="Eliminar_profesores()"> Eliminar Profesores </a>
