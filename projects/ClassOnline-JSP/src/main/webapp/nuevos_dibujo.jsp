...
<html lang="en">
    ...
    <head>
        ...
        <script>
            ...
            function inicio() {
                window.location.href = ("dibujotaudiovisual.html?user=" + userParam);
            }
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <%
                                                    ...
                                                    try {
                                                        result = stat.executeQuery("select*from calculo_temas where tipo_tema='Dibujo'");
