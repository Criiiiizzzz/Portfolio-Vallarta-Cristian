                                            ...
                                            <div class="col-lg-6" align="left">
                                                <script type="text/javascript">
                                                    ...
                                                    function submitForm() {
                                                        ...
                                                        formulario.setAttribute('action', ("calis.jsp?user=" + userParam));
                                                ...
                                                <div class="left-info" align="center">
                                                    ...
                                                    <center><h2 class="create-account"> Calificaciones: </h2></center>
                                                        <%
                                                            ...
                                                            try {
                                                                result = stat.executeQuery("select*from calificaciones_usuario where usuario='" + user + "';");
                                                                ArrayList<String> calificaciones = new ArrayList<String>();
                                                                out.println("<table border='1px' align=center>"
                                                                        + "<th>&nbsp Semestre &nbsp  </th>"
                                                                        + "<th>&nbsp  Parcial 1  &nbsp</th>"
                                                                        + "<th>&nbsp  Parcial 2  &nbsp</th>"
                                                                        + "<th>&nbsp  Parcial 3  &nbsp</th>"
                                                                        + "<th>&nbsp  Final     &nbsp</th>");
                                                                while (result.next()) {
                                                                    String con = result.getString("Id_calificacion");
                                                                    calificaciones.add(con);

                                                                }
                                                                for (int i = 0; i < calificaciones.size(); ++i) {
                                                                    result = stat.executeQuery("select*from calificaciones where Id_calificacion='" + calificaciones.get(i) + "'");
                                                                    result.next();
                                                        ...
                                                        %>
                                                    <tr>
                                                        <td><%=result.getString("semestre")%></td>
                                                        <td><%=result.getString("primer")%></td>
                                                        <td><%=result.getString("segundo")%></td>
                                                        <td><%=result.getString("tercero")%></td>
                                                        <td><%out.println(resultado);%></td>
                                                    </tr>
                                                    <%
