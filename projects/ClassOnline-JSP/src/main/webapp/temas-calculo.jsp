                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <%
                                                    ...
                                                    try {
                                                        result = stat.executeQuery("select*from calculo_temas where tipo_tema='Calculo'");
                                                ...
                                                %>
                                                <div class="col-lg-6" style="float: left; margin-left: 1px;">
                                                    <div class="left-info" style="width: 900px;height: 400px; margin-left: 40%">
                                                        <h3 style="text-align: center"><%=result.getString("tema")%></h3>
                                                        <p><%=result.getString("descripcion")%></p>
                                                    <a href="editar-tema.jsp?cod=<%=result.getString("Id_tema")%>&admin=<%=admin%>">
                                                        <h5 style="color: white; font-family: sans-serif; text-align: justify; float: left;">EDITAR</h5>
                                                    </a>
                                                    <a href="eliminar-tema.jsp?paso=<%=result.getString("Id_tema")%>&admin=<%=admin%>">
