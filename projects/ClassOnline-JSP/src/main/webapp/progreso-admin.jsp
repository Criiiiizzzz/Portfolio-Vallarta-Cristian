                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4 align-self-center">
                                            <div class="main-info header-text">
                                                ...
                                                <div>
                                                    <a href="https://www.instagram.com/restaurantelostrescompadres/"><img style="width: 20px; height: 20px;" src="img/INSTAGRAM.png" alt=""></a>
                                                    <a href="https://www.instagram.com/restaurantelostrescompadres/"><img style="width: 20px; height: 20px; " src="img/FACEBOOK.png" alt=""></a>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-4 align-self-center">
