    ...
    <body>
        <%
            ...
            try{
                ...
                sta.executeUpdate("delete from gerente_mantenimiento where mantenimiento='"+cod+"';");
            
                request.getRequestDispatcher("perfil-admin.jsp?admin="+user).forward(request,response);
