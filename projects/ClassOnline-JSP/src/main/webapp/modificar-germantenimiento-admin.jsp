                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="left-info" align="center" style="color: white">
                                                    ...
                                                    <%
                                                        ...
                                                        try {
                                                            result = stat.executeQuery("select*from gerente_mantenimiento where mantenimiento='" + user + "'");
                                                            result.next();
                                                    %>
                                                    <form action="" method="post" id="contact_form">
                                                        ...
                                                        <div class="nombre">
                                                            <label for="name"></label>
                                                            <input  type="text" placeholder="Nombre" name="nombre_mantenimiento" pattern="^[a-zA-ZÀ-ÿ\u00f1\u00d1\u00E0-\u00FC]+(\s*[a-zA-ZÀ-ÿ\u00f1\u00d1\u00E0-\u00FC]*)*[a-zA-ZÀ-ÿ\u00f1\u00d1\u00E0-\u00FC]+$" value="<%=result.getString("nombre_mantenimiento")%>" id="name_input" required>
                                                        </div>
                                                        <p>Email</p>
                                                        <div class="apellidos">
                                                            <label for="apellidos"></label>
                                                            <input  type="text" placeholder="Email" pattern="^[a-zA-ZÀ-ÿ\u00f1\u00d1\u00E0-\u00FC]+(\s*[a-zA-ZÀ-ÿ\u00f1\u00d1\u00E0-\u00FC]*)*[a-zA-ZÀ-ÿ\u00f1\u00d1\u00E0-\u00FC]+$" name="email_mantenimiento" value="<%=result.getString("email_mantenimiento")%>" required>
                                                        </div>
                                                        <p>Contraseña</p>
                                                        <div class="correo">
                                                            <label for="email"></label>
                                                            <input  type="text" placeholder="CONTRASEÑA" name="contrasenia_mantenimiento" id="email_input" value="<%=result.getString("contrasenia_mantenimiento")%>" required>
                                                        </div> 
                                                        <br><br><br>
                                            ...
                                            <%
                                                ...
                                                if (request.getParameter("btngrabar") != null) {
                                                    ...
                                                    String nom = new String(request.getParameter("nombre_mantenimiento").getBytes("ISO-8859-1"), "UTF-8");
                                                    String mail = new String(request.getParameter("email_mantenimiento").getBytes("ISO-8859-1"), "UTF-8");
                                                    String con = new String(request.getParameter("contrasenia_mantenimiento").getBytes("ISO-8859-1"), "UTF-8");
                                                    stat.execute("update gerente_mantenimiento set mantenimiento='" + user2 + "', nombre_mantenimiento='" + nom + "', email_mantenimiento='" + mail + "', contrasenia_mantenimiento='" + con + "'where mantenimiento='" + user + "';");
