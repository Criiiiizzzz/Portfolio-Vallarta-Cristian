    ...
    <body>
        ...
        <div id="container">
            ...
            <div class="product" data-name="p-5">
                <a href="poro.jsp"><img src="imagenes/fruta5.jfif" alt=""></a>
                <h3>Poro</h3>
                <div class="price">$40.00</div>
            </div>
            <form action="poroo.jsp" method="post">
                        <h3>Cantidad de poro</h3>
                        <select name="fresa">
                                <option>1kg Poro</option>
                                <option>2kg Poro</option>
                                <option>3kg Poro</option>
                            </select>
