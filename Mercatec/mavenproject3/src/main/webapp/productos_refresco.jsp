...
<html lang="es">
    ...
    <body style="background-color: white;">
        ...
        <section class="container">
            ...
            <h3 class="title"> &bull; Refrescos &bull; </h3>
            ...
            <div class="products-container">
                ...
                <div class="product" data-name="p-2">
                    <a href="refresco2.jsp"><img src="imagenes/r2.jfif" alt=""></a>
                    <h3>Sprite</h3>
                    <div class="price">$40.00</div>
                </div>

                <div class="product" data-name="p-3">
                    <a href="refresco3.jsp"><img src="imagenes/r3.jfif" alt=""></a>
                    <h3>Mirinda</h3>
                    <div class="price">$30.00</div>
                </div>

                <div class="product" data-name="p-4">
                    <a href="refresco4.jsp"><img src="imagenes/r4.jfif" alt=""></a>
                    <h3>Dr. pepper</h3>
                    <div class="price">$25.00</div>
                </div>

                <div class="product" data-name="p-5">
                    <a href="refresco5.jsp"><img src="imagenes/r5.jfif" alt=""></a>
                    <h3>Delaware</h3>
                    <div class="price">$37.00</div>
                </div>

                <div class="product" data-name="p-6">
                    <a href="refresco6.jsp"><img src="imagenes/r6.jfif" alt=""></a>
                    <h3>Manzanita</h3>
                ...
                <%
                    ...
                    try {
                        result = stat.executeQuery("select*from productos where tipo_producto='Refrescos'");
                        ArrayList<String> Refrescos = new ArrayList<String>();
                        while (result.next()) {
                ...
                <%      for (int i = 0; i < Refrescos.size(); ++i) {
                        result = stat.executeQuery("select*from productos where Id_producto='" + Refrescos.get(i) + "';");
                        result.next();


                %>
                <div class="product" data-name="p-6">
                    <a href="productos_papa.jsp"><img src="images/6.png" alt=""></a>
