    ...
    <body>
        ...
        <div id="container">
            ...
            <div class="product" data-name="p-1">
                    <a href="Ribeye.jsp"><img src="imagenes/carne1.jfif" alt=""></a>
                    <h3>Ribeye de res</h3>
                    <div class="price">$2033.00</div>
            </div>
            
                <form action="rib.jsp" method="post">
                            <h3>Kilos</h3>
                            <select name="fresa">
                                    <option>1 kg ribeye de res</option>
                                    <option>2 kg ribeye de res</option>
                                    <option>3 kg ribeye de res</option>
                                </select>
