...
<html>
    <head>
        ...
        <script>
            ...
            function inicio() {
                window.location.href = ("inicio-vendedor.html?vendedor=" + userParam);
            }
            function mercados() {
                window.location.href = ("tianguises-vendedor.html?vendedor=" + userParam);
            }
            function catalogo() {
                window.location.href = ("productos-vendedor.jsp?vendedor=" + userParam);
            }
            function nosotros() {
            ...
            function Modificar() {
                window.location.href = ("modificar-usuario.jsp?vendedor=" + userParam);
            }

            function Modificar_Productos() {
                window.location.href = ("modificar-productos-vendedor.jsp?vendedor=" + userParam);
            }
            function Agregar_Productos() {
                window.location.href = ("agregar-productos-vendedor.jsp?vendedor=" + userParam);
            }
            function Consultar_Usuarios() {
                window.location.href = ("Consultar_Repartidores.jsp?vendedor=" + userParam);
            }
            function Modificar_Usuarios() {
                window.location.href = ("eliminar_usuario.jsp?vendedor=" + userParam);
            }
        </script>
                ...
                <form id="contact_form">
                    <%
                        ...
                        try {
                            ...
                            conec = DriverManager.getConnection("jdbc:mysql://localhost:3308/MercaTec?autoReconnect=true&useSSL=false", "root", "n0m3l0");
                        ...
                        try {
                            contra = request.getParameter("vendedor");
                            results = stat.executeQuery("select * from vendedores where contrasenia_vend='" + contra + "';");
                            if (results.next()) {
                    ...
                    <div class="telephone">
                        ...
                        <br><br>
                        <input type="text" onkeypress="validar(event, 'letras')" placeholder="Usuario" name="user" id="telephone_input" value="<%out.println(results.getString("usuario_vend"));%>" readonly >
                    </div>
                    <div class="name">
                        <label for="name">USUARIO</label>
                        <br><br>
                        <input type="text" onkeypress="validar(event, 'letras')" placeholder="Nombre" name="nom_user" id="name_input" value="<%out.println(results.getString("nom_vend"));%>" readonly>
                    </div>

                    <div class="email">
                        <label for="email">APELLIDO PATERNO</label>
                        <br><br>
                        <input type="text" placeholder="Apellido Paterno" onkeypress="validar(event, 'letras')" name="ap_paterno_user" value="<%out.println(results.getString("ap_paterno_vend"));%>" readonly>
                    </div>

                    <div class="name">
                        <label for="name">APELLIDO MATERNO</label>
                        <br><br>
                        <input type="text" onkeypress="validar(event, 'letras')" placeholder="Apellido Materno" name="ap_materno_user" id="name_input" value="<%out.println(results.getString("ap_materno_vend"));%>" readonly>
                    </div>

                    <div class="email">
                        <label for="email">EMAIL</label>
                        <br><br>
                        <input type="email" placeholder="E-mail" name="email" id="email_input" value="<%out.println(results.getString("email_vend"));%>" readonly>
                    </div>

                    <div class="email">
                        <label for="email">TELÉFONO</label>
                        <br><br>
                        <input type="text" onkeypress="validar(event, 'numeros')" placeholder="Numero Telefónico" name="num_user" id="telephone_input"  value="<%out.println(results.getString("num_vend"));%>"readonly>
                    </div>
                    <div class="name">
                        <label for="email">CONTRASEÑA</label>
                        <br><br>
                        <input type="text"  placeholder="Contraseña" name="contrasenia" id="name_input" value="<%out.println(results.getString("contrasenia_vend"));%>" readonly>
                    </div>
                    <%} else {
                    ...
                    <div class="submit">
                        <a href="index.html"><input type="button" value="Cerrar Sesiòn" id="form_button" /></a>
                    </div>
                    <form id="contact_form">
                        <h3>Funciones</h3>
                        <br>
                        <a  href="javascript:void(0)" onclick="Agregar_Productos()"><input value="Agregar Productos" id="form_button" style="text-align: center;"/></a>
                        <br>
                        <br>
                        <a  href="javascript:void(0)" onclick="Modificar_Productos()"><input value="Modificar Productos" id="form_button" style="text-align: center;"/></a>
                        <br>
                        <br>
                        <a  href="javascript:void(0)" onclick="Consultar_Usuarios()"><input value="Consultar Repartidores" id="form_button" style="text-align: center;"/></a>
                        <br>
                        <br>
                        <a  href="javascript:void(0)" onclick="Modificar_Usuarios()"><input value="Modificar Repartidores " id="form_button" style="text-align: center;"/></a>
                        <br>
                    </form>
                </form>
