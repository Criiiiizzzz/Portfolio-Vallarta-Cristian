    ...
    <body>
        ...
        <div id="container">
            ...
            <div class="product" data-name="p-1">
                <a href="platano.jsp"><img src="imagenes/fruta1.jfif" alt=""></a>
                <h3>Platano</h3>
                <div class="price">$37.00</div>
            </div>
                <form action="platanoo.jsp" method="post">
                        <h3>Cantidad de platanos</h3>
                        <select name="fresa">
                                <option>1kg Platanos</option>
                                <option>2kg Platanos</option>
                                <option>3kg Platanos</option>
                            </select>
