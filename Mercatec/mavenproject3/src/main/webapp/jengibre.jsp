    ...
    <body>
        ...
        <div id="container">
            ...
            <div class="product" data-name="p-3">
                <a href="jengibre.jsp"><img src="imagenes/fruta3.jfif" alt=""></a>
                <h3>Jengibre</h3>
                <div class="price">$189.00</div>
            </div>
            <form action="jengibree.jsp" method="post">
                        <h3>Cantidad de jengibres</h3>
                        <select name="fresa">
                                <option>1kg Jengibre</option>
                                <option>2kg Jengibre</option>
                                <option>3kg Jengibre</option>
                            </select>
