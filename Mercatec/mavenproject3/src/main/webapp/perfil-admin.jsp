            ...
            <div id="container">
                ...
                <form id="contact_form">
                    ...
                    <div class="telephone">
                        ...
                        <br><br>
                        <input type="text" onkeypress="validar(event, 'letras')" placeholder="Usuario" name="user" id="telephone_input" value="<%out.println(results.getString("administrador"));%>" readonly >
                    </div>
                    <div class="name">
                        <label for="name">USUARIO</label>
                        <br><br>
                        <input type="text" onkeypress="validar(event, 'letras')" placeholder="Nombre" name="nom_user" id="name_input" value="<%out.println(results.getString("nombre_admin"));%>" readonly>
                    </div>

                    <div class="email">
                        <label for="email">APELLIDO PATERNO</label>
                        <br><br>
                        <input type="text" placeholder="Apellido Paterno" onkeypress="validar(event, 'letras')" name="ap_paterno_user" value="<%out.println(results.getString("ap_paterno_admin"));%>" readonly>
                    </div>

                    <div class="name">
                        <label for="name">APELLIDO MATERNO</label>
                        <br><br>
                        <input type="text" onkeypress="validar(event, 'letras')" placeholder="Apellido Materno" name="ap_materno_user" id="name_input" value="<%out.println(results.getString("ap_materno_admin"));%>" readonly>
                    </div>

                    <div class="email">
                        <label for="email">EMAIL</label>
                        <br><br>
                        <input type="email" placeholder="E-mail" name="email" id="email_input" value="<%out.println(results.getString("email_admin"));%>" readonly>
                    </div>

                    <div class="email">
                        <label for="email">TELÉFONO</label>
                        <br><br>
                        <input type="text" onkeypress="validar(event, 'numeros')" placeholder="Numero Telefónico" name="num_user" id="telephone_input"  value="<%out.println(results.getString("num_admin"));%>"readonly>
                    </div>
                    <div class="name">
                        <label for="email">CONTRASEÑA</label>
                        <br><br>
                        <input type="text"  placeholder="Contraseña" name="contrasenia" id="name_input" value="<%out.println(results.getString("contrasenia_admin"));%>" readonly>
                    </div>
                    <%} else {
                    ...
                    <form id="contact_form">
                        ...
                        <br>
                        <br>
                        <a  href="javascript:void(0)" onclick="Consultar_Usuarios()"><input value="Consultar Usuarios" id="form_button" style="text-align: center;"/></a>
                        <br>
                        <br>
                        <a  href="javascript:void(0)" onclick="Modificar_Usuarios()"><input value="Modificar Usuarios" id="form_button" style="text-align: center;"/></a>
                        <br>
