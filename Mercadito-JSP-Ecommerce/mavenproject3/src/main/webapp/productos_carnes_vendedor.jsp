...
<html lang="es">
    <head>
        ...
        <script>
            ...
            function Consultar_Usuarios() {
                window.location.href = ("Consultar_Usuarios.jsp?vendedor=" + userParam);
            }
    ...
    <body style="background-color: white;">
        ...
        <section class="container">
            ...
            <h3 class="title"> &bull; Carnes &bull; </h3>
            ...
            <div class="products-container">
                ...
                <%
                    ...
                    try {
                        result = stat.executeQuery("select*from productos_vendedor where tipo_producto='Carnes'");
                ...
                <div class="product" data-name="p-6">
                    <a href="carne1.jsp"><img src="imagenes/carne1.jfif" alt=""></a>
