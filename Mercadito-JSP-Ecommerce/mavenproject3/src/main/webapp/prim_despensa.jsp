    ...
    <body>
        ...
        <div id="container">
            ...
            <div class="product" data-name="p-1">
                <a href="prim_despensa.jsp"><img src="imagenes/pequeña.jpg" alt=""></a>
                <h3>Basica</h3>
                <div class="price">$500.00</div>
            </div>

             <form action="jitomates.jsp" method="post">
                        <input type="text" value="Despensa basica" name="nombre" readonly>
                        <input type="text" value="" name="cantidad">
                <br><br>
                        <input type="text" value="500.00" name="precio" readonly>
                        
