    ...
    <body>
        ...
        <div id="container">
            ...
            <div class="product" data-name="p-3">
                    <a href="ter_despensa.jsp"><img src="imagenes/grande.png" alt=""></a>
                    <h3>Avanzada</h3>
                    <div class="price">$2000.00</div>
                </div>
<form action="jitomates.jsp" method="post">
                        <input type="text" value="Despensa avanzada" name="nombre" readonly>
                        <input type="text" value="" name="cantidad">
                <br><br>
                        <input type="text" value="2000.00" name="precio" readonly>
                        
