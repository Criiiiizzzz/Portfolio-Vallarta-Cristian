...
<html lang="en">
    ...
    <head>
        ...
        <script>
            ...
            function frutas() {
                window.location.href = ("nuevos_fruta.jsp?admin=" + userParam);
            }
            function leguminosas() {
                window.location.href = ("productos_leguminosas.jsp?admin=" + userParam);
            }
            function carne() {
                window.location.href = ("productos_carnes.jsp?admin=" + userParam);
            }
            function refrescos() {
                window.location.href = ("productos_refresco.jsp?admin=" + userParam);
            }
