        ...
        <div class="contenedor">
            ...
            <div id="container">
                ...
                <%
                    ...
                    try {
                        results = stat.executeQuery("select*from usuarios where usuario='" + user + "'");
                        results.next();
                %>
                <form action="" method="post" id="contact_form">
                    <div class="telephone">
                        ...
                        <br><br>
                        <input type="text" onkeypress="validar(event, 'letras')" placeholder="Usuario" name="admin2" id="telephone_input" value="<%=user%>" required >
                    </div>
                    <div class="name">
                        <label for="name">NOMBRE</label>
                        <br><br>
                        <input  type="text" placeholder="Nombre" name="nom_user" pattern="^[a-zA-ZÀ-ÿ\u00f1\u00d1\u00E0-\u00FC]+(\s*[a-zA-ZÀ-ÿ\u00f1\u00d1\u00E0-\u00FC]*)*[a-zA-ZÀ-ÿ\u00f1\u00d1\u00E0-\u00FC]+$" value="<%=results.getString("nom_user")%>" id="name_input" required>
                    </div>

                    <div class="email">
                        <label for="email">APELLIDO PATERNO</label>
                        <br><br>
                        <input  type="text" placeholder="Email" pattern="^[a-zA-ZÀ-ÿ\u00f1\u00d1\u00E0-\u00FC]+(\s*[a-zA-ZÀ-ÿ\u00f1\u00d1\u00E0-\u00FC]*)*[a-zA-ZÀ-ÿ\u00f1\u00d1\u00E0-\u00FC]+$" name="ap_paterno_user" value="<%=results.getString("ap_paterno_user")%>" required>
                    </div>

                    <div class="name">
                        <label for="name">APELLIDO MATERNO</label>
                        <br><br>
                        <input  type="text" placeholder="Email" pattern="^[a-zA-ZÀ-ÿ\u00f1\u00d1\u00E0-\u00FC]+(\s*[a-zA-ZÀ-ÿ\u00f1\u00d1\u00E0-\u00FC]*)*[a-zA-ZÀ-ÿ\u00f1\u00d1\u00E0-\u00FC]+$" name="ap_materno_user" value="<%=results.getString("ap_materno_user")%>" required>
                    </div>

                    <div class="email">
                        <label for="email">EMAIL</label>
                        <br><br>
                        <input  type="text" placeholder="Email" pattern="^[a-zA-ZÀ-ÿ\u00f1\u00d1\u00E0-\u00FC]+(\s*[a-zA-ZÀ-ÿ\u00f1\u00d1\u00E0-\u00FC]*)*[a-zA-ZÀ-ÿ\u00f1\u00d1\u00E0-\u00FC]+$" name="email" value="<%=results.getString("email")%>" required>
                    </div>

                    <div class="email">
                        <label for="email">NUMERO</label>
                        <br><br>
                        <input  type="text" placeholder="Email"  name="num_user" value="<%=results.getString("num_user")%>" required>
                    </div>
                    <div class="name">
                        <label for="email">CONTRASEÑA</label>
                        <br><br>
                        <input type="text"  placeholder="Contraseña" name="contrasenia" id="name_input" value="<%out.println(results.getString("contrasenia"));%>" required>
                    </div>
                    <br><br><br>
                    ...
                    if (request.getParameter("btngrabar") != null) {
                        ...
                        String app = new String(request.getParameter("ap_paterno_user").getBytes("ISO-8859-1"), "UTF-8");
                        String apm = new String(request.getParameter("ap_materno_user").getBytes("ISO-8859-1"), "UTF-8");
                        ...
                        stat.execute("update usuarios set usuario='" + user2 + "', nom_user='" + nom + "', ap_paterno_user='" + app + "', ap_materno_user='" + apm + "', email='" + mail + "' , contrasenia='" + con + "' where usuario='" + user + "';");
                ...
                <script type="text/javascript">
                    ...
                    setTimeout(function () {
                        window.location.href = "eliminar_usuario2.jsp?admin=<%=admin%>";
                    }, 1000);
                </script> 
                <%
