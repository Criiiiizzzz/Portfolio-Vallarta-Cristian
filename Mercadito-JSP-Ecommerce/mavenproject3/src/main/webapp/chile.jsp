    ...
    <body>
        ...
        <div id="container">
            ...
            <div class="product" data-name="p-2">
                <a href="chile.jsp"><img src="imagenes/fruta2.jfif" alt=""></a>
                <h3>Chile</h3>
                <div class="price">$96.00</div>
            </div>
            <form action="chilee.jsp" method="post">
                        <h3>Cantidad de chiles</h3>
                        <select name="fresa">
                                <option>1kg Chile</option>
                                <option>2kg Chile</option>
                                <option>3kg Chile</option>
                            </select>
